...
@notificationRouter.get("/analyseNotificationService/notification/{user_id}")
...
@notificationRouter.delete("/analyseNotificationService/notification/{notification_id}")
...
@notificationRouter.put("/analyseNotificationService/read_notification/{notification_id}")
...
@notificationRouter.put("/analyseNotificationService/unread_notification/{notification_id}")
...
@notificationRouter.get("/analyseNotificationService/read_notifications/")
def mark_all_notif_readed(db: Session = Depends(get_db)):
    return notification_controller.markAllAsRead (db)

@notificationRouter.post("/analyseNotificationService/accept_notifications/{user_id}")
...
@notificationRouter.post("/analyseNotificationService/refuse_notifications/{user_id}")
...
@notificationRouter.post("/analyseNotificationService/sendEmails/")
