...
environment {
    ...
    DOCKER_IMAGE_NAME = "notificationservice"
...
//              sh "helm upgrade usermanagement usermanagement/back1 --set image.tag:v${DOCKER_IMAGE_TAG} -n helm-test"
            sh "helm upgrade usermanagement https://chikhaoui-firas99.github.io/helm-back3/back3-0.1.0.tgz --set image.tag=v${DOCKER_IMAGE_TAG} -n helm-test"
        }
       }
      }
   }
